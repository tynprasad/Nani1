...
public class Nationalities
{
	...
	public void Nationalities(WebDriver driver,String TestScriptName,ExtentTest logger,ExtentReports extent)
		{
			this.driver = driver;
			this.logger=logger;
			this.extent=extent;
	...
	public  void AddNationality(String Nationality) throws Exception
	{
